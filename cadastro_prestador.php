...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare e bind para inserir dados do prestador
    ...
    if ($stmt->execute()) {
        // Captura o ID do prestador inserido
...
<head>
    ...
    <title>Cadastro de Prestador - ONFICINA</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="cadastro_prestador.php">
            <input type="text" name="nome_prestador" placeholder="Nome" required>
            <input type="text" name="sobrenome_prestador" placeholder="Sobrenome" required>
            <input type="email" name="email_prestador" placeholder="Email" required>
            <input type="text" name="telefone_prestador" placeholder="Telefone" required>
            <input type="password" name="senha_prestador" placeholder="Senha" required>
            <input type="text" name="cpf_prestador" placeholder="CPF" required>
            <input type="text" name="cnpj_prestador" placeholder="CNPJ (Opcional)">
            <h3>Endereço</h3>
